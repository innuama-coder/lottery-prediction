...
def main() -> int:
    ...
    try:
        ...
        checks = {
            ...
            "path_classified_numeric_contract": "P4-LOCAL-PATH-CLASSIFIED-BINARY64-4" in joined,
            "feature_coefficient_probability_profiles": all(marker in joined for marker in ("derived_feature_context_v2", "derived_coefficient_v1", "top1000_derived_probability_display_v3")),
