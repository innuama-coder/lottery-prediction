# Agent Instructions — TASK-999

Karpathy Context Engineering contract for the current task.

## Role

Produce only the named Research Report for `TASK-999`: `docs/research/TASK-999-lottery-autoresearch-research-acceptance.md`.
...
3. `tasks/research/v1.0.0-lottery-autoresearch-roadmap/fixtures/TASK-999/PROMPT.md`
...
- The only allowed Research Report path is `docs/research/TASK-999-lottery-autoresearch-research-acceptance.md` under `docs/research/`.
- No betting automation, profit promise or claim of approaching 100% prediction.

## Verification and handoff

Run the direct verification commands listed in `PROMPT.md`. Hand off the report path, sources, validator output, PASS/HOLD/FAIL verdict, blockers, residual risks and whether dependents may start.
