...
def main() -> int:
    ...
    try:
        ...
        checks = {
            ...
            "path_classified_numeric_contract": "P4-LOCAL-PATH-CLASSIFIED-BINARY64-5" in joined,
            "source_class_profiles": all(marker in joined for marker in ("derived_feature_context_v2", "derived_number_feature_context_v1", "derived_coefficient_v1", "propagated_zone_score_v1", "top1000_derived_probability_display_v3")),
            "probability_display_narrow_paths": "三个 Top-1000 display-probability" in joined or "三个 display `joint_probability`" in joined,
