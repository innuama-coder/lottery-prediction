# Agent Instructions — TASK-002

Karpathy Context Engineering contract for the current task.

## Role

Produce only the named Research Report for `TASK-002`: `docs/research/TASK-002-canonical-dataset-provenance-contract.md`.
...
3. `tasks/research/v1.0.0-lottery-autoresearch-roadmap/fixtures/TASK-002/PROMPT.md`
...
- The only allowed Research Report path is `docs/research/TASK-002-canonical-dataset-provenance-contract.md` under `docs/research/`.
