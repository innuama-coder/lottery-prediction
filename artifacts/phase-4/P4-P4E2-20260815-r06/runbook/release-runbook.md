...
PHASE4_PYTHON=.p4-local-venv/bin/python scripts/phase4/local-accept-release --release artifacts/phase-4/P4-P4E2-20260815-r06
```
...
RID=P4-P4E2-20260815-r06
REL=artifacts/phase-4/$RID
IMPL=96c4a353e480529443454633ac67de6a66aed133
