...
def _pending_payload(draft: dict[str, Any], snapshot_sha: str, change_set: dict[str, Any], recorded_at: str) -> bytes:
...
def create() -> dict[str, Any]:
    ...
    pending_payload = _pending_payload(draft, manifest_sha, change_set, recorded_at)
