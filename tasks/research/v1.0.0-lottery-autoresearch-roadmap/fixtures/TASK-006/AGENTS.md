# Agent Instructions — TASK-006

Karpathy Context Engineering contract for the current task.

## Role

Produce only the named Research Report for `TASK-006`: `docs/research/TASK-006-autoresearch-architecture-safety.md`.
...
3. `tasks/research/v1.0.0-lottery-autoresearch-roadmap/fixtures/TASK-006/PROMPT.md`
...
- The only allowed Research Report path is `docs/research/TASK-006-autoresearch-architecture-safety.md` under `docs/research/`.
