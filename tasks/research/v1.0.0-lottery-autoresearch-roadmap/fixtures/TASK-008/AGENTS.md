# Agent Instructions — TASK-008

Karpathy Context Engineering contract for the current task.

## Role

Produce only the named Research Report for `TASK-008`: `docs/research/TASK-008-prospective-shadow-validation-protocol.md`.
...
3. `tasks/research/v1.0.0-lottery-autoresearch-roadmap/fixtures/TASK-008/PROMPT.md`
...
- The only allowed Research Report path is `docs/research/TASK-008-prospective-shadow-validation-protocol.md` under `docs/research/`.
