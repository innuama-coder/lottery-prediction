# Claude Task Context — TASK-999

Karpathy Context Engineering contract for the current task.

Role: research-report author and evidence reviewer for `最终研究验收与实施准入评审`.

Fixed planning input: `tasks/research/v1.0.0-lottery-autoresearch-roadmap/research-planning.json`
Fixed task input: `tasks/research/v1.0.0-lottery-autoresearch-roadmap/fixtures/TASK-999/PROMPT.md`
Fixed relationship input: `tasks/research/v1.0.0-lottery-autoresearch-roadmap/fixtures/TASKS.md`
Fixed output: `docs/research/TASK-999-lottery-autoresearch-research-acceptance.md`
...
- run the direct roadmap and acceptance-report verification commands listed in `PROMPT.md`.
