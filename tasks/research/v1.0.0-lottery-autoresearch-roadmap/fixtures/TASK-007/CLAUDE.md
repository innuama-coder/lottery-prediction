# Claude Task Context — TASK-007

Karpathy Context Engineering contract for the current task.

Role: research-report author and evidence reviewer for `合成基准与 Autoresearch 元评估协议`.

Fixed planning input: `tasks/research/v1.0.0-lottery-autoresearch-roadmap/research-planning.json`
Fixed task input: `tasks/research/v1.0.0-lottery-autoresearch-roadmap/fixtures/TASK-007/PROMPT.md`
Fixed relationship input: `tasks/research/v1.0.0-lottery-autoresearch-roadmap/fixtures/TASKS.md`
Fixed output: `docs/research/TASK-007-synthetic-benchmark-protocol.md`
