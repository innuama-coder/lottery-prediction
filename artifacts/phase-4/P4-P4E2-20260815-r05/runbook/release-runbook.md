...
PHASE4_PYTHON=.p4-local-venv/bin/python scripts/phase4/local-accept-release --release artifacts/phase-4/P4-P4E2-20260815-r05
```
...
RID=P4-P4E2-20260815-r05
REL=artifacts/phase-4/$RID
IMPL=2d35c72c6de985cb87f595a17455885861356a09
