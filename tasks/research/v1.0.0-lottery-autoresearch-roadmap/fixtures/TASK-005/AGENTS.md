# Agent Instructions — TASK-005

Karpathy Context Engineering contract for the current task.

## Role

Produce only the named Research Report for `TASK-005`: `docs/research/TASK-005-model-feature-selection-study.md`.
...
3. `tasks/research/v1.0.0-lottery-autoresearch-roadmap/fixtures/TASK-005/PROMPT.md`
...
- The only allowed Research Report path is `docs/research/TASK-005-model-feature-selection-study.md` under `docs/research/`.
