...
def historical_repair_draft_path(repo_root: Path = ROOT, archive_root: Path | None = None) -> Path:
    ...
    return repo_root / "artifacts/phase-0/batches" / C_AFTER_BATCH_ID / REPAIR_DRAFT_RELATIVE
...
def verify_archived_repair_draft(
    ...
    after_archive = after_archive_root or repo_root / "artifacts/phase-0/batches" / C_AFTER_BATCH_ID
