...
$PY scripts/phase4/run_acceptance_command.py --release "$REL" --attempt-id A09-bottom-up -- $PY -m lottery_system.phase4.real_cli validate --release "$REL"
