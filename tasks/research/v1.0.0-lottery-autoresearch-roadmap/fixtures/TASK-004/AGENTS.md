# Agent Instructions — TASK-004

Karpathy Context Engineering contract for the current task.

## Role

Produce only the named Research Report for `TASK-004`: `docs/research/TASK-004-sequential-evaluation-governance.md`.
...
3. `tasks/research/v1.0.0-lottery-autoresearch-roadmap/fixtures/TASK-004/PROMPT.md`
...
- The only allowed Research Report path is `docs/research/TASK-004-sequential-evaluation-governance.md` under `docs/research/`.
