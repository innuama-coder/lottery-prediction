# Claude Task Context — TASK-008

Karpathy Context Engineering contract for the current task.

Role: research-report author and evidence reviewer for `前瞻影子验证与研究转产品决策协议`.

Fixed planning input: `tasks/research/v1.0.0-lottery-autoresearch-roadmap/research-planning.json`
Fixed task input: `tasks/research/v1.0.0-lottery-autoresearch-roadmap/fixtures/TASK-008/PROMPT.md`
Fixed relationship input: `tasks/research/v1.0.0-lottery-autoresearch-roadmap/fixtures/TASKS.md`
Fixed output: `docs/research/TASK-008-prospective-shadow-validation-protocol.md`
